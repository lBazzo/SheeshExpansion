...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 100 : 20,
        }),
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = { .absorbPercentage = B_UPDATED_MOVE_DATA >= GEN_8 ? 50 : 50 },
        .mirrorMoveBanned = B_UPDATED_MOVE_FLAGS < GEN_8,
        .metronomeBanned = TRUE,
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
    ...
    [MOVE_BADDY_BAD] =
    {
        .name = COMPOUND_STRING("Baddie Bad"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ICE_SPINNER] =
    {
        ...
        .effect = EFFECT_HIT, //EFFECT_ICE_SPINNER,
        .power = 80,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_TWIN_FLAME] =
    {
        .name = COMPOUND_STRING("Twin Flame"),
        .description = COMPOUND_STRING(
            "User shoots a concentrated\n"
            "ball of fire twice in a row."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_MIND_FLARE] =
    {
        .name = COMPOUND_STRING("Mind Flare"),
        .description = COMPOUND_STRING(
            "A desperation attack. Power\n"
            "doubles if last move failed."),
        .effect = EFFECT_STOMPING_TANTRUM,
