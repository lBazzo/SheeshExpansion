...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_PAWMI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_IRON_FIST, ABILITY_NONE },
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_FLAME_BODY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_FLAME_BODY, ABILITY_WEAK_ARMOR },
