...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_SUPER_LUCK, ABILITY_OVERGROW },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_INNER_FOCUS, ABILITY_SPEED_BOOST },
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_QUICK_FEET, ABILITY_SCRAPPY, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_GALE_WINGS, ABILITY_KEEN_EYE, ABILITY_DRIZZLE },
    #else
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .abilities = { ABILITY_TRACE, ABILITY_MIND_GAME, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ralts"),
        .cryId = CRY_RALTS,
    ...
    [SPECIES_SLAKOTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_VIGOROTH}),
    },
    ...
    [SPECIES_VIGOROTH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_QUICK_FEET, ABILITY_TOUGH_CLAWS, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 65, SPECIES_SLAKING}),
    },
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_UNBURDEN, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_WIND_RIDER, ABILITY_SWARM, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_TECHNICIAN, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Budew"),
        .cryId = CRY_BUDEW,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SPEED_BOOST, ABILITY_ROUGH_SKIN  },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_FRIEND_GUARD, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_WAILORD}),
    },
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_SHEER_FORCE, ABILITY_SIMPLE },
    #else
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_UNBURDEN, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_STRONG_JAW, ABILITY_HYPER_CUTTER, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_LEVITATE, ABILITY_BUG_EYED, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_SAND_RUSH, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_PIXILATE, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_SUPER_LUCK, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SENSE_DANGER, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_NOCTURNAL, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_EARTH_EATER, ABILITY_HYDRATION },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_WHISCASH}),
    },
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_MAGIC_BOUNCE, ABILITY_FORCEFIELD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_GOOEY, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_INTIMIDATE, ABILITY_SHADOW_TAG },
    #else
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_LEVITATE, ABILITY_SHADOW_SHIELD, ABILITY_STICKY_HOLD },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_IRON_FIST, ABILITY_SHADOW_SHIELD, ABILITY_STICKY_HOLD },
    #else
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHARPNESS, ABILITY_SENSE_DANGER, ABILITY_NONE },
    #else
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
                                ,{EVO_LEVEL, 0, SPECIES_FROSLASS, CONDITIONS({IF_KNOWS_MOVE, MOVE_SHADOW_BALL})}
                            #endif
                            ),
    },
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_TRACE, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_HUNTAIL] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_STURDY, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOREBYSS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_DAZZLING, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SHEER_FORCE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_HEAVY_METAL, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_STURDY, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NO_GUARD, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FILTER, ABILITY_STEELY_SPIRIT, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_MIND_GAME, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
