...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_THICK_FAT, ABILITY_CHLOROPHYLL, ABILITY_OVERGROW },
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_DRAGON_HERITAGE, ABILITY_SOLAR_POWER },
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_MEGA_LAUNCHER, ABILITY_TORRENT },
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_SWARM, ABILITY_SNIPER },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PICHU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_LIGHTNING_ROD, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_LIGHTNING_ROD, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_LEVITATE, ABILITY_SURGE_SURFER, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Raichu"),
        .cryId = CRY_RAICHU,
        .natDexNum = NATIONAL_DEX_RAICHU,
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_SAND_RUSH, ABILITY_ROUGH_SKIN },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_TECHNICIAN, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandshrew"),
        .cryId = CRY_SANDSHREW,
        .natDexNum = NATIONAL_DEX_SANDSHREW,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SHEER_FORCE, ABILITY_HUSTLE },
    #else
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_SUPER_LUCK, ABILITY_POISON_POINT },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VULPIX_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIXILATE, ABILITY_SERENE_GRACE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Vulpix"),
        .cryId = CRY_VULPIX,
        .natDexNum = NATIONAL_DEX_VULPIX,
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_HUGE_POWER, ABILITY_COMPETITIVE },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_FRIEND_GUARD },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_WIGGLYTUFF}),
    },
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_INFILTRATOR, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NOCTURNAL, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_GLOOM}),
    },
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SUN_GAZER, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MEOWTH_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_TOUGH_CLAWS, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Meowth"),
        .cryId = CRY_MEOWTH,
        .natDexNum = NATIONAL_DEX_MEOWTH,
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SUPER_LUCK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH}, 
                                {EVO_LEVEL, 40, SPECIES_POLIWRATH}
                            #if P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_QUICK_FEET, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_MAGIC_GUARD, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Abra"),
        .cryId = CRY_ABRA,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_MACHOKE}),
    },
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_ILLUMINATE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECKLESS, ABILITY_PIXILATE, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ponyta"),
        .cryId = CRY_PONYTA,
        .natDexNum = NATIONAL_DEX_PONYTA,
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FORCEFIELD, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_IRON_BARBS, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_FORCEFIELD, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_ANALYTIC, ABILITY_MAGNET_PULL },
        .bodyColor = BODY_COLOR_GRAY,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCRAPPY, ABILITY_KEEN_EYE, ABILITY_STEADFAST },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Farfetch'd"),
        .cryId = CRY_FARFETCHD,
        .natDexNum = NATIONAL_DEX_FARFETCHD,
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_CORROSION, ABILITY_GLUTTONY, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Grimer"),
        .cryId = CRY_GRIMER,
        .natDexNum = NATIONAL_DEX_GRIMER,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_MIND_GAME, ABILITY_SHADOW_TAG}
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_FILTER, ABILITY_STURDY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 56, SPECIES_STEELIX}),
    #endif
    },
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_STURDY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_VOLTORB_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_STEELWORKER, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Voltorb"),
        .cryId = CRY_VOLTORB,
        .natDexNum = NATIONAL_DEX_VOLTORB,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_MAGIC_BOUNCE, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                {EVO_LEVEL, 36, SPECIES_EXEGGUTOR},
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_FLOWER_BLOCK, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Exeggutor"),
        .cryId = CRY_EXEGGUTOR,
        .natDexNum = NATIONAL_DEX_EXEGGUTOR,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STURDY, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MAROWAK_ALOLA_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_UNBURDEN, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Marowak"),
        .cryId = CRY_MAROWAK,
        .natDexNum = NATIONAL_DEX_MAROWAK,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_NO_GUARD, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_PINK,
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_LICKILICKY}),
    #endif
    },
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_FLARE_BOOST, ABILITY_NONE },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_FLARE_BOOST, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_WEEZING},
    ...
    [SPECIES_WEEZING_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_CORROSION, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Weezing"),
        .cryId = CRY_WEEZING,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SOLID_ROCK, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_SERENE_GRACE, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TANGLING_HAIR, ABILITY_CHLOROPHYLL, ABILITY_NONE },
    #else
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_DAMP, ABILITY_SNIPER },
    #else
    ...
    [SPECIES_STARYU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_ILLUMINATE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_GEN_2_CROSS_EVOS
                                {EVO_LEVEL, 0, SPECIES_SCIZOR, CONDITIONS({IF_KNOWS_MOVE_TYPE, TYPE_STEEL})}
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_TECHNICIAN, ABILITY_SWARM },
    #else
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_NO_GUARD, ABILITY_FORCEFIELD, ABILITY_DRY_SKIN },
    #else
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_IRON_FIST, ABILITY_SUPER_LUCK, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MOTOR_DRIVE, ABILITY_SUPER_LUCK, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_IRON_FIST, ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
    ...
    [SPECIES_MAGMORTAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_HYPER_CUTTER, ABILITY_MOXIE },
    #else
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_QUICK_FEET, ABILITY_SHEER_FORCE },
    #else
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_DRAGON_HERITAGE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_MULTISCALE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRIAGE, ABILITY_FILTER, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TERAVOLT, ABILITY_VOLT_ABSORB, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_QUICK_FEET, ABILITY_GUTS, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_SCALES, ABILITY_SLUSH_RUSH, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIXILATE, ABILITY_SERENE_GRACE, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_TRACE, ABILITY_DOWNLOAD },
    #else
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_THICK_FAT, ABILITY_GLUTTONY, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_BLACK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_SNORLAX}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_REFRIGERATE, ABILITY_FILTER, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARTICUNO_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_MAGIC_BOUNCE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Articuno"),
        .cryId = CRY_ARTICUNO,
        .natDexNum = NATIONAL_DEX_ARTICUNO,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_KEEN_EYE, ABILITY_WIND_POWER, ABILITY_STATIC },
    #else
    ...
    [SPECIES_ZAPDOS_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SCRAPPY, ABILITY_SPEED_BOOST, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Zapdos"),
        .cryId = CRY_ZAPDOS,
        .natDexNum = NATIONAL_DEX_ZAPDOS,
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_GALE_WINGS, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MOLTRES_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DARK_AURA, ABILITY_SHADOW_SHIELD, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Moltres"),
        .cryId = CRY_MOLTRES,
        .natDexNum = NATIONAL_DEX_MOLTRES,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_MULTISCALE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PROTEAN, ABILITY_PRANKSTER, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
