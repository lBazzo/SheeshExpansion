...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_NIGHT_OWL, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SKITTER_SPEED, ABILITY_SNIPER, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GREEN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_SUPER_LUCK, ABILITY_SERENE_GRACE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_FLUFFY, ABILITY_STATIC, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 100 : 100)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_GALVANIZE, ABILITY_ILLUMINATE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_FORCEFIELD, ABILITY_SHADOW_TAG },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_QUICK_FEET, ABILITY_NONE, ABILITY_UNNERVE },
    #else
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NATURAL_CURE, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_PINK,
