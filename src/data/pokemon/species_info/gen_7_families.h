...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_NONE, ABILITY_WIMP_OUT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_NONE, ABILITY_EMERGENCY_EXIT },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POISON_POINT, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_PURPLE,
