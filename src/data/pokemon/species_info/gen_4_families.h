...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = { ABILITY_FUR_COAT, ABILITY_STATIC, ABILITY_PICKUP },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_DARK_AURA, ABILITY_INFILTRATOR, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SUPER_LUCK, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_PURPLE,
