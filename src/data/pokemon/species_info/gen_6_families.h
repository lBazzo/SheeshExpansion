...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_OVERGROW, ABILITY_NONE },
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_OVERGROW, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_LEVITATE, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_SUPER_LUCK, ABILITY_TORRENT },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_INTIMIDATE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_BLOCK, ABILITY_SUPERSWEET_SYRUP, ABILITY_PASTEL_VEIL }, \
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                      \
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .abilities = { ABILITY_FLOWER_BLOCK, ABILITY_SUPERSWEET_SYRUP, ABILITY_FAIRY_AURA },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_CORROSION, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_MIND_GAME, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STURDY, ABILITY_SOLID_ROCK, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYRANTRUM, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    #endif
        .abilities = { ABILITY_UNBURDEN, ABILITY_MOLD_BREAKER, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_GOOEY, ABILITY_POISON_HEAL, ABILITY_SAP_SIPPER },
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_HEAVY_METAL, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
        .natDexNum = NATIONAL_DEX_SLIGGOO,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_STURDY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_AVALUGG_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_TECHNICIAN, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Avalugg"),
        .cryId = CRY_AVALUGG,
        .natDexNum = NATIONAL_DEX_AVALUGG,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = { ABILITY_INFILTRATOR, ABILITY_PRANKSTER, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_TURBOBLAZE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BROWN,
