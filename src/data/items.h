...
// Evolution Items
    ...
    [ITEM_UPGRADE] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 100 * TREASURE_FACTOR : 100,
    ...
    [ITEM_PRISM_SCALE] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 100 : ((I_PRICE >= GEN_7) ? 100 : 100),
        .description = COMPOUND_STRING(
            "A mysterious scale\n"
            "that evolves a\n"
            "certain Pokémon."),
