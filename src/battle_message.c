...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SPIKESARESCATTERED]                   = COMPOUND_STRING("Spikes are scattered on the ground all around {B_DEF_TEAM2} team!"),
    ...
    [STRINGID_PKMNCUTSSPECIALATTACKWITH]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Special Attack!"),
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_HG_VICTORY_WILD}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_HG_VICTORY_WILD}{PAUSE 127}"),
    ...
    [STRINGID_FAULTYSHIELDACTIVATES]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} partially covered itself using its {B_LAST_ITEM}!"),
};
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_SET_SPIKES]           = STRINGID_SPIKESARESCATTERED,
