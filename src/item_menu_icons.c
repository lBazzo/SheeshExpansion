...
static const union AnimCmd sSpriteAnim_Bag_DamageUp[] =
{
    ANIMCMD_FRAME(320, 4),
    ANIMCMD_END
};
...
static const union AnimCmd sSpriteAnim_Bag_Specific[] =
{
    ANIMCMD_FRAME(256, 4),
    ANIMCMD_END
};
...
static const union AnimCmd *const sBagSpriteAnimTable[] =
{
    ...
    [POCKET_DAMAGE_UP]    = sSpriteAnim_Bag_DamageUp,
    ...
    [POCKET_SPECIFIC]     = sSpriteAnim_Bag_Specific,
