...
const u8 gText_Vermilion[] = _("Vermillion");
...
const u8 gPCText_Shift[] = _("Shife");
...
// New Repellent
const u8 gText_RepellentOn[] = _("Turned on the Repellent.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepellentOff[] = _("Turned off the Repellent.{PAUSE_UNTIL_PRESS}");
