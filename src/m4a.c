...
BSS_CODE ALIGNED(4) u32 hq_buffer_ptr[0x130] = {0}; // size = 0xE0 or 0x130 
...
void m4aSoundInit(void)
{
    ...
    m4aSoundMode(SOUND_MODE_DA_BIT_8
               | SOUND_MODE_FREQ_18157 // SOUND_MODE_FREQ_13379 or SOUND_MODE_FREQ_18157
               | (12 << SOUND_MODE_MASVOL_SHIFT)
               | (15 << SOUND_MODE_MAXCHN_SHIFT)); // 5, 12, or 15?
