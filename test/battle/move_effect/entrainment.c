...
//Bazzo note: changed to Rock Throw to avoid speed drop ai interference
AI_DOUBLE_BATTLE_TEST("AI prefers Entrainment'ing good abilities onto partner with bad ability")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_ARCHEN) { Level(17); Ability(ABILITY_DEFEATIST); Moves(MOVE_DUAL_WINGBEAT, MOVE_ROCK_THROW); } // changed to rock throw
    } WHEN {
