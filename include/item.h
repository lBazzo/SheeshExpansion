...
static inline u16 GetPCItemQuantity(u16 *quantity)
{
    return *quantity;
}

static inline void SetPCItemQuantity(u16 *quantity, u16 newValue)
{
    *quantity = newValue;
}
...
bool8 CheckPCHasSpace(u16 itemId, u16 count); // HnS
