...
//extern const u8 BattleScript_StartingWeatherStarts[];
extern const u8 BattleScript_StartingHailWeatherStarts[];
extern const u8 BattleScript_StartingSnowWeatherStarts[];
extern const u8 BattleScript_StartingSunWeatherStarts[];
extern const u8 BattleScript_StartingSandstormWeatherStarts[];
extern const u8 BattleScript_StartingRainWeatherStarts[];
...
extern const u8 BattleScript_MindGameActivates[];
extern const u8 BattleScript_MindGamePrevented[];
extern const u8 BattleScript_MindGameInReverse[];
...
extern const u8 BattleScript_FaultyShieldActivated[];
