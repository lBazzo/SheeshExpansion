...
#define VAR_GAMECORNER_STATE                             0x40E3 // Var is written to, but never read
...
#define VAR_TRAINER_BATTLE_OPPONENT_A 0x8015 // Alias of gTrainerBattleOpponent_A and TRAINER_BATTLE_PARAM.opponentA
