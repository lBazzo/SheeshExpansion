...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_THREATENING_AURA = 311,
    ABILITY_FIERY_DEMEANOUR = 312,
    ABILITY_SENSE_DANGER = 313,
    ABILITY_OLD_PICKPOCKET_PLACEHOLDER = 314,
    ABILITY_SKITTER_SPEED = 315,
    ABILITY_SUN_GAZER = 316,
    ABILITY_FLOWER_BLOCK = 317,
    ABILITY_NOCTURNAL = 318,
    ABILITY_DRAGON_HERITAGE = 319,
    ABILITY_FORCEFIELD = 320,
    ABILITY_BUG_EYED = 321,
    ABILITY_AMPHIBIAN = 322,
    ABILITY_MIND_GAME = 323,
