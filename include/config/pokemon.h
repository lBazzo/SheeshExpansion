...
#define P_LEGENDARY_PERFECT_IVS          GEN_5  // Since Gen 6, Legendaries, Mythicals and Ultra Beasts found in the wild or given through gifts have at least 3 perfect IVs.
...
#define P_TUTOR_MOVES_ARRAY              FALSE   // FALSE  // If TRUE, generates a gTutorMoves array automatically using make_teachables.py. (generally not needed, but the HGSS Pokedex has an optional use for it)

// Flag settings
// To use the following features in scripting, replace the 0s with the flag ID you're assigning it to.
// Eg: Replace with FLAG_UNUSED_0x264 so you can use that flag to toggle the feature.
#define P_FLAG_FORCE_SHINY               FLAG_MAKE_GYARADOS_SHINY  // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
