...
#define AI_BAD_SCORE_THRESHOLD                                  99 // Move scores beneath this threshold are considered "bad" when deciding switching
...
#define LOW_ACCURACY_THRESHOLD                                  0 // Moves with accuracy equal OR below this value are considered low accuracy
...
#define ASSUME_STATUS_HIGH_ODDS                         0 // Chance for AI to see extremely likely moves for a pokemon to have, like Spore
#define ASSUME_STATUS_MEDIUM_ODDS                       0 // Chance for AI to see moderately likely moves for a pokemon to have, like Protect
#define ASSUME_STATUS_LOW_ODDS                          0 // Chance for AI to see niche moves a pokemon may have but probably won't, like Entrainment
#define ASSUME_ALL_STATUS_ODDS                          0 // Chance for the AI to see any kind of status move.
...
#define FRIENDLY_FIRE_RISKY_THRESHOLD             0 // AI_FLAG_RISKY acceptable number of hits to KO the partner via friendly fire
#define FRIENDLY_FIRE_NORMAL_THRESHOLD            0 // typical acceptable number of hits to KO the partner via friendly fire
#define FRIENDLY_FIRE_CONSERVATIVE_THRESHOLD      0 // AI_FLAG_CONSERVATIVE acceptable number of hits to KO the partner via friendly fire
// Counterplay on the assumption of opponents Protecting.
#define DOUBLE_TRICK_ROOM_ON_LAST_TURN_CHANCE    0 // both pokemon use Trick Room on turn Trick Room expires in the hopes both opponents used Protect to stall, getting a free refresh on the timer
#define TAILWIND_IN_TRICK_ROOM_CHANCE            0 // use Tailwind on turn Trick Room expires in the hopes both opponents used Protect to stall
...
#define GUARD_SPLIT_ALLY_PERCENTAGE     0
#define GUARD_SPLIT_ENEMY_PERCENTAGE    0
#define POWER_SPLIT_ALLY_PERCENTAGE     0
